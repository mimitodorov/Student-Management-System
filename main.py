...
# ADD logo for main program
## Just a small logo for our project to show creativity must be a .ico or .png file

# ADD backgrounds instead of colors
## Main program can be made more colorful but keep it practical and minimalistic
## If possible make the most effecient layout for the GUI

# ADD LOGS
## Create text file of entered values (very extremely optional)
